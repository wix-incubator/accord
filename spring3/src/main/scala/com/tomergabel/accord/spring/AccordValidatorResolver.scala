...
package com.tomergabel.accord.spring

import scala.reflect.ClassTag
import com.tomergabel.accord.Validator
import java.lang.reflect.{ParameterizedType, Method}

/** A resolver that takes a class and returns its respective [[com.tomergabel.accord.Validator]]. */
trait AccordValidatorResolver {

  /** Takes a class and returns a [[com.tomergabel.accord.Validator]], if available.
    *
