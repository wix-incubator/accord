...
object Combinators {
   ...
   * is specified by whomever instantiates [[com.tomergabel.accord.dsl.Combinators.NumericPropertyWrapper]] the
   ...
   * [[com.tomergabel.accord.dsl.Combinators.Empty]] and [[com.tomergabel.accord.dsl.Combinators..NotEmpty]]
   * combinators.
   *
   ...
   * to conform to the structural type [[com.tomergabel.accord.dsl.Combinators.HasEmpty]], and by requiring
   * a view bound from `T` to [[com.tomergabel.accord.dsl.Combinators.HasEmpty]] at the call site (e.g.
   ...
   * @tparam T The type that conforms, directly or implicitly, to [[com.tomergabel.accord.dsl.Combinators.HasEmpty]].
   * @return The specified object, strictly-typed as [[com.tomergabel.accord.dsl.Combinators.HasEmpty]].
   */
  ...
  /**
   * An implicit conversion to enable any collection-like object (e.g. strings, options) to be handled by the
   * [[com.tomergabel.accord.dsl.Combinators.Size]] combinator.
   *
   * [[java.lang.String]] does not directly implement `size` (in practice it is implemented in
   * [[scala.collection.IndexedSeqOptimized]], via an implicit conversion and an inheritance stack), and this is
   * a case where the Scala compiler does not always infer structural types correctly. By requiring
   * a view bound from `T` to [[scala.collection.GenTraversableOnce]] we can force any collection-like structure
   * to conform to the structural type [[com.tomergabel.accord.dsl.Combinators.HasSize]], and by requiring
   * a view bound from `T` to [[com.tomergabel.accord.dsl.Combinators.HasSize]] at the call site (i.e.
   * [[com.tomergabel.accord.dsl.size]]) we additionally support any class that directly conforms to the
   * structural type as well.
   *
   * @param gto An object that is, or is implicitly convertible to, [[scala.collection.GenTraversableOnce]].
   * @tparam T The type that conforms, directly or implicitly, to [[com.tomergabel.accord.dsl.Combinators.HasSize]].
   * @return The specified object, strictly-typed as [[com.tomergabel.accord.dsl.Combinators.HasSize]].
   */
