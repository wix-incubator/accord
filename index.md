...
* __Integrated__: Other than providing its own DSL and matcher library, Accord is designed to easily integrate with other libraries, and provides out-of-the-box integration with [Spring Validation](https://github.com/wix/accord/blob/master/spring3/README.md), [Specs<sup>2</sup>](https://github.com/wix/accord/blob/master/specs2/README.md) and [ScalaTest](https://github.com/wix/accord/blob/master/scalatest/README.md).
